(function() {
    ...
    function init() {
        formElements.form = document.getElementById('loginForm');
        formElements.email = document.getElementById('loginEmail');
        formElements.senha = document.getElementById('loginSenha');

        if (!formElements.form || !formElements.email || !formElements.senha) return;
